    ...
    public static partial class TableGenerator
    {
        public static void GenerateRDM()
        {
            ...
            Table[] tables =
            {
                ...
                new("5.5 BiS", "패치 5.5 BiS 리스트입니다.", new ClassJobCategory {RDM = true},
                    new GearSet("글쿨 2.5초 제작 보강 반지 세트.", "글로벌 쿨다운을 2.5초로 맞춘 장비 세트. 제작 보강 반지로 인해 아이템 레벨과 체력이 살짝 낮은 것에 유의.", "Smoked Chicken", 20899.20d,
