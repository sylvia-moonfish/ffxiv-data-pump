            ...
            var tables = new Table[]
            {
                ...
                new("5.5 BiS", "패치 5.4 ~ 5.5 BiS 리스트입니다.", new ClassJobCategory {PLD = true},
                    ...
                    new GearSet(
                        ...
                        new Gear("Edenmorn Ring of Fending", "dh60", "dh60"),
                        new Gear("Augmented Cryptlurker's Ring of Fending", "ch60", "ch60"))),
                new("5.55 레지스탕스 BiS", "패치 5.55 레지스탕스 웨폰을 채용한 BiS 리스트입니다.", new ClassJobCategory {PLD = true},
                    new GearSet("글쿨 2.43초 느린 기시 세트.",
                        "글로벌 쿨다운을 2.43초로 맞춘 장비 세트. 기믹 때문에 성령을 빼 딜싸이클을 조절해야 하는 재생 영식 2, 3층 딜갱신에 효율적. 음식을 치킨 페투치네로 바꿀 경우 글로벌 쿨다운이 2.42초로 낮아지며 기믹 외 업타임 로스가 없는 재생 영식 2층 등에 더 적합해짐.",
                        "Smoked Chicken", 13916.3d, new Gear("Blade's Honor", "ch 379", "det 379", "sks 86"),
                        new Gear("Blade's Fortitude", "ch 141", "det 121", "ten 38", "sks 38"),
                        new Gear("Augmented Cryptlurker's Elmo of Fending", "dh60", "dh60"),
                        new Gear("Edenmorn Coat of Fending", "dh60", "dh60"),
                        new Gear("Edenmorn Armguards of Fending", "ch60", "dh60"),
                        new Gear("Edenmorn Leather Belt of Fending", "dh60", "dh60"),
                    ...
                    new GearSet("글쿨 2.41초 암기/건브 호환 추천 세트.",
                        "글로벌 쿨다운을 2.41초로 맞춘 장비 세트. 재생 영식 1 ~ 4층 전층에서 쓰기 적합하고 가장 무난한 추천 세트. 암흑기사와 건브레이커 BiS와도 호환됨.",
                        "Chicken Fettuccine", 13942.0d, new Gear("Blade's Honor", "ch 379", "det 379", "ten 26", "sks 60"),
                        new Gear("Blade's Fortitude", "ch 149", "det 139", "ten 50"),
                        new Gear("Augmented Cryptlurker's Elmo of Fending", "dh60", "dh60"),
                        new Gear("Edenmorn Coat of Fending", "dh60", "dh60"),
                        new Gear("Edenmorn Armguards of Fending", "ch60", "dh60"),
                        new Gear("Edenmorn Leather Belt of Fending", "dh60", "dh60"),
                    ...
                    new GearSet(
                        "글쿨 2.40초 빠른 기시 세트.",
                        "글로벌 쿨다운을 2.40초로 맞춘 장비 세트. 빠른 기시를 선호할 경우 추천. 암흑기사, 건브레이커 BiS와는 호환되지 않음.",
                        "Chicken Fettuccine", 13945.9d, new Gear("Blade's Honor", "ch 379", "det 379", "sks 86"),
                        new Gear("Blade's Fortitude", "ch 131", "det 88", "ten 43", "sks 76"),
                        new Gear("Augmented Cryptlurker's Elmo of Fending", "dh60", "dh60"),
                        new Gear("Edenmorn Coat of Fending", "dh60", "dh60"),
                        new Gear("Edenmorn Armguards of Fending", "ch60", "dh60"),
                        new Gear("Edenmorn Leather Belt of Fending", "dh60", "dh60"),
